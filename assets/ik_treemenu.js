;(function ( $, window, document, undefined ) {
	...
	var pluginName = 'ik_treemenu',
		defaults = {
			...
			'instructions': 'Use up or down arrows to move through menu items, and Enter of Spacebar to toggle submenus open and closed.',
			'expandAll': true
		};
	...
	Plugin.prototype.init = function () {
		...
		$elem // set all li elements as tree folders and items
			...
			$elem // make the first treeitme focusable
				.find('li:first')
				.attr({
					'tabindex': 0
				});
